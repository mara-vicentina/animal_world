...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'species' => 'espécie',
        'race' => 'raça',
        'castrated_animal' => 'animal castrado',
        ...
        'value' => 'valor',
        'reason' => 'motivo',
        'which_vaccines' => 'quais vacinas',
        'up_to_date_vaccines' => 'vacinas em dia',
        'up_to_date_deworming' => 'vermifugação em dia',
        'use_antiparasitics' => 'antiparasitários em dia',
        'previous_surgeries' => 'cirurgias anteriores',
        'illnesses_chronic_conditions' => 'doenças ou condições crônicas',
        'medication' => 'medicação',
        'main_symptoms' => ' sintomas principais',
        'change_behavior' => 'mudança no comportamento',
        'temperature' => 'temperatura corporal',
        'heart_respiratory_rate' => 'frequência cardíaca e respiratória',
        'mucous_membranes_hydration' => 'mucosas e hidratação',
        'weight' => 'peso',
        'pain_scale' => 'escala de dor',
        'skin_coat' => 'pele e pelagem',
        'eyes_ears' => 'olhos e ouvidos',
        'oral_cavity' => 'cavidade oral',
        'observations_description' => 'observações e descrição',
